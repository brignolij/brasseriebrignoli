...
<section class="mb-32 text-center text-gray-800" id="contact">
    <div class="max-w-[700px] mx-auto px-3 lg:px-6">
      ...
      <a class="pr-2 text-6xl" href="https://www.instagram.com/brasseriebrignoli/"><Icon name="uil:instagram" color="GoldenRod" /></a>
      <a class="pr-2 text-6xl" href="https://www.facebook.com/profile.php?id=100091994670742"><Icon name="uil:facebook" color="GoldenRod"  /></a>
      </p>
      <br>
      <form id="formId"
